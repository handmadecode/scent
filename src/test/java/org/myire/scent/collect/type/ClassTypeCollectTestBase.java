...
/**
 * Abstract base class with unit tests related to parsing and collecting metrics for class types,
 * e.g. normal classes, enum classes, and record classes.
 *
 * @author <a href="mailto:peter@myire.org">Peter Franzen</a>
 */
abstract public class ClassTypeCollectTestBase extends TypeCollectTestBase
{
    /**
